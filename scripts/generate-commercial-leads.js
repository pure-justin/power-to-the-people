 ...
 * Generates 500+ commercial properties in Nevada and imports to Firestore
 *
 * Usage:
 *   node scripts/generate-commercial-leads.js [options]
 *
 * Options:
...
async function main() {
  ...
  try {
    ...
    console.log("📡 Step 1: Generating commercial properties for Nevada...\n");

    const properties = generateProperties(options.limit);

    console.log(`\n✅ Generated ${properties.length} total properties`);

    // Step 2: Display statistics
    console.log("\n📊 Step 2: Analyzing generated properties...\n");
    ...
    console.log(`   Properties generated: ${properties.length}`);
    if (!options.dryRun) {
      console.log(
