...
export default function RoiProjection() {
  ...
  const [systemSizeKw, setSystemSizeKw] = useState(0); // 0 = auto-size
  ...
  const [viewMode, setViewMode] = useState("lease"); // 'lease' or 'purchase'
  ...
  const projection = useMemo(() => {
    if (systemSizeKw > 0) {
      ...
      const panelCount = Math.ceil(
        (systemSizeKw * 1000) / ROI_DEFAULTS.panelWattage,
      );
    ...
    return quickEstimate(monthlyBill, utilityRate);
  }, [
    monthlyBill,
    utilityRate,
    systemSizeKw,
  ...
  const { system, costs, metrics, environmental, yearlyData } = projection;
  ...
  return (
    <div className="page">
      <style>{`
        ...
        .roi-table .savings-cell {
          color: #059669;
          font-weight: 600;
        }

        .roi-table .negative-cell {
          color: #dc2626;
        }
      ...
      <nav className="roi-nav">
        <div className="roi-nav-content">
          ...
          <div className="roi-nav-links">
            ...
            <Link to="/compare" className="roi-nav-link">
              Compare
            </Link>
      ...
      <div className="roi-page">
        ...
        <div className="roi-hero">
          <div className="container">
            ...
            <p className="roi-hero-subtitle">
              See exactly how much you'll save over 25 years with solar +
              battery. Adjust your inputs and watch the numbers change in
              real-time.
            </p>
          </div>
        </div>
        ...
        <div className="roi-content">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="roi-tooltip-row">
                        <span className="roi-tooltip-label">Utility Only:</span>
          ...
          {/* Year-by-Year Table */}
          <div className="roi-chart-card">
            <div className="roi-chart-title" style={{ marginBottom: 16 }}>
              <DollarSign size={20} />
