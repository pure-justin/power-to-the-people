...
exports.adminStatsApi = exports.createLeadApi = exports.getLeadsApi = void 0;
 ...
 */
exports.getLeadsApi = functions.https.onRequest(async (req, res) => {
    // CORS headers
 ...
 */
exports.createLeadApi = functions.https.onRequest(async (req, res) => {
    // CORS
    res.set("Access-Control-Allow-Origin", "*");
 ...
 */
exports.adminStatsApi = functions.https.onRequest(async (req, res) => {
    res.set("Access-Control-Allow-Origin", "*");
    if (req.method === "OPTIONS") {
        res.status(204).send("");
        return;
    ...
    try {
        // Require ADMIN scope
        const apiKeyData = await (0, apiKeys_1.validateApiKeyFromRequest)(req, apiKeys_1.ApiKeyScope.ADMIN);
        ...
        const stats = {
            ...
            activeApiKeys: apiKeysSnapshot.docs.filter((doc) => doc.data().status === "active").length,
...
*/
//# sourceMappingURL=apiKeyIntegration.example.js.map