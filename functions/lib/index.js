...
exports.submitPermit = exports.createPermit = exports.addSurveyPhoto = exports.reviewSurvey = exports.getSurveysByProject = exports.getSurvey = exports.submitSurvey = exports.updateSurvey = exports.createSurvey = exports.getAhjStats = exports.verifyAhj = exports.getPermitSop = exports.createPermitSop = exports.updateAhjRequirements = exports.findAhjForAddress = exports.searchAhj = exports.getAhj = exports.createAhj = exports.getTaskStats = exports.retryAiTask = exports.getTaskQueue = exports.completeHumanTask = exports.escalateToHuman = exports.processAiTask = exports.createAiTask = exports.marketplaceApi = exports.getMarketplaceListings = exports.searchWorkers = exports.registerWorker = exports.rateWorker = exports.completeMarketplaceJob = exports.acceptBid = exports.submitBid = exports.createMarketplaceListing = exports.projectApi = exports.getProjectTimeline = exports.completeProjectTask = exports.assignProjectTask = exports.createProjectTask = exports.advanceProjectStage = exports.syncInvoiceStatus = exports.cancelMercuryInvoice = exports.listMercuryInvoices = exports.getMercuryInvoice = exports.createMercuryInvoice = exports.createMercuryCustomer = exports.getProjectSmsHistory = exports.handleIncomingSms = exports.updateSmsPreferences = exports.twilioStatusCallback = void 0;
exports.addAuditCheck = exports.certifyAudit = exports.getAuditsByProject = exports.getAudit = exports.auditProjectCredits = exports.onFundingComplete = exports.onInstallComplete = exports.onPermitApproved = exports.onDesignApproved = exports.onSurveyApproved = exports.generateBankabilityPackage = exports.getFundingByProject = exports.requestMilestonePayment = exports.updateFundingStatus = exports.submitFunding = exports.checkDocumentReadiness = exports.createFundingPackage = exports.getInstallProgress = exports.signOffPhase = exports.requestPhotoReview = exports.getPhaseStatus = exports.getPhotosByProject = exports.uploadInstallPhoto = exports.getCustomerSchedule = exports.getUpcomingInstalls = exports.getInstallSchedule = exports.reschedule = exports.confirmSchedule = exports.proposeSchedule = exports.getAvailability = exports.setAvailability = exports.eagleviewWebhook = exports.getEagleviewResults = exports.shouldOrderEagleview = exports.getEagleviewReport = exports.processEagleviewDelivery = exports.checkEagleviewStatus = exports.orderEagleviewReport = exports.calculateSystemSize = exports.approveDesign = exports.updateDesign = exports.getDesignsByProject = exports.getDesign = exports.generateDesign = exports.checkPermitStatuses = exports.resolveCorrection = exports.addPermitCorrection = exports.getPermitsByProject = exports.getPermit = exports.updatePermitStatus = void 0;
exports.syncConfigStatus = exports.getSolarProposal = exports.generateSolarProposal = exports.calculateSolarTaxBenefits = exports.calculateSolarRECValue = exports.runFinancialAnalysis = exports.estimateSolarProduction = exports.calculateSolarSystemSize = exports.notifyTaskReady = exports.notifyBidResult = exports.notifyMatchingWorkers = exports.closeBidWindows = exports.checkSlaDeadlines = exports.seedZipCoordinates = exports.deliverWebhookEvent = exports.webhookApi = exports.getDocumentStats = exports.saveDocumentTemplate = exports.voidDocument = exports.signDocument = exports.viewDocument = exports.sendDocument = exports.getDocumentsByProject = exports.getDocument = exports.generateDocument = exports.customerApi = exports.getCreditMarketStats = exports.getCreditTransactions = exports.completeCreditTransfer = exports.initiateCreditTransfer = exports.respondToOffer = exports.makeOffer = exports.getCreditListing = exports.searchCreditListings = exports.createCreditListing = exports.getInsurance = exports.activateInsurance = exports.quoteCreditInsurance = exports.assessCreditRisk = void 0;
...
Object.defineProperty(exports, "updateSmsPreferences", { enumerable: true, get: function () { return smsNotifications_1.updateSmsPreferences; } });
Object.defineProperty(exports, "handleIncomingSms", { enumerable: true, get: function () { return smsNotifications_1.handleIncomingSms; } });
Object.defineProperty(exports, "getProjectSmsHistory", { enumerable: true, get: function () { return smsNotifications_1.getProjectSmsHistory; } });
...
Object.defineProperty(exports, "marketplaceApi", { enumerable: true, get: function () { return marketplaceApi_1.marketplaceApi; } });
...
Object.defineProperty(exports, "getEagleviewResults", { enumerable: true, get: function () { return eagleviewService_1.getEagleviewResults; } });
Object.defineProperty(exports, "eagleviewWebhook", { enumerable: true, get: function () { return eagleviewService_1.eagleviewWebhook; } });
...
Object.defineProperty(exports, "customerApi", { enumerable: true, get: function () { return customerApi_1.customerApi; } });
...
var webhookApi_1 = require("./webhookApi");
Object.defineProperty(exports, "webhookApi", { enumerable: true, get: function () { return webhookApi_1.webhookApi; } });
Object.defineProperty(exports, "deliverWebhookEvent", { enumerable: true, get: function () { return webhookApi_1.deliverWebhookEvent; } });
// Export Location Matching functions (geo-based worker matching)
var locationMatching_1 = require("./locationMatching");
Object.defineProperty(exports, "seedZipCoordinates", { enumerable: true, get: function () { return locationMatching_1.seedZipCoordinates; } });
// Export Marketplace Automation functions (scheduled + triggered)
var marketplaceAutomation_1 = require("./marketplaceAutomation");
Object.defineProperty(exports, "checkSlaDeadlines", { enumerable: true, get: function () { return marketplaceAutomation_1.checkSlaDeadlines; } });
Object.defineProperty(exports, "closeBidWindows", { enumerable: true, get: function () { return marketplaceAutomation_1.closeBidWindows; } });
Object.defineProperty(exports, "notifyMatchingWorkers", { enumerable: true, get: function () { return marketplaceAutomation_1.notifyMatchingWorkers; } });
Object.defineProperty(exports, "notifyBidResult", { enumerable: true, get: function () { return marketplaceAutomation_1.notifyBidResult; } });
Object.defineProperty(exports, "notifyTaskReady", { enumerable: true, get: function () { return marketplaceAutomation_1.notifyTaskReady; } });
// Export Financial Engine functions (system sizing, production, financial analysis)
var financialEngine_1 = require("./financialEngine");
Object.defineProperty(exports, "calculateSolarSystemSize", { enumerable: true, get: function () { return financialEngine_1.calculateSolarSystemSize; } });
Object.defineProperty(exports, "estimateSolarProduction", { enumerable: true, get: function () { return financialEngine_1.estimateSolarProduction; } });
Object.defineProperty(exports, "runFinancialAnalysis", { enumerable: true, get: function () { return financialEngine_1.runFinancialAnalysis; } });
Object.defineProperty(exports, "calculateSolarRECValue", { enumerable: true, get: function () { return financialEngine_1.calculateSolarRECValue; } });
Object.defineProperty(exports, "calculateSolarTaxBenefits", { enumerable: true, get: function () { return financialEngine_1.calculateSolarTaxBenefits; } });
// Export Proposal Generator functions (customer-facing proposal generation)
var proposalGenerator_1 = require("./proposalGenerator");
Object.defineProperty(exports, "generateSolarProposal", { enumerable: true, get: function () { return proposalGenerator_1.generateSolarProposal; } });
Object.defineProperty(exports, "getSolarProposal", { enumerable: true, get: function () { return proposalGenerator_1.getSolarProposal; } });
// Export Config Sync function (admin-only, bridges functions.config → Firestore)
var configSync_1 = require("./configSync");
Object.defineProperty(exports, "syncConfigStatus", { enumerable: true, get: function () { return configSync_1.syncConfigStatus; } });
