 ...
 */
exports.updateReferralStatusHttp = functions.https.onCall(
  async (data, context) => {
...
module.exports = {
  onProjectCreated: exports.onProjectCreated,
  onProjectUpdated: exports.onProjectUpdated,
  updateReferralStatusHttp: exports.updateReferralStatusHttp,
  getReferralStats: exports.getReferralStats,
  processWeeklyPayouts: exports.processWeeklyPayouts,
};
